...
public class EvidenciaModulosJDBC {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            statement.executeUpdate("INSERT INTO USUARIOS(USUARIO, CONTRASEÑA) VALUES('CARLOS',3945)");
...
try {
    ...
    String sqlEliminarUsuario = "DELETE FROM USUARIOS WHERE USUARIO = '" + usuarioAEliminar + "'";
    statement.executeUpdate(sqlEliminarUsuario);
